...
require_once ROOT_PATH . '/plugins/aliyunSmsSdk/vendor/autoload.php';
...
class Sms {
    ...
    public static function sendSms($mobile, $code, $scene) {
        ...
        $request->setSignName("茁禹科技");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        switch ($scene) {
            case 'resiter':
                $templateCode = 'SMS_164420030';
                break;
            case 2:
                $templateCode = 'SMS_164420029';
                break;

            case 3:
                $templateCode = 'SMS_165107016';
                break;
                
            default:
                $templateCode = 'SMS_165116914';
                break;
        }
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIijomJ3pUbOLC"; // AccessKeyId

        $accessKeySecret = "TNlQyETSKs1DrlByMknPbiHD0jsLjI"; // AccessKeySecret
